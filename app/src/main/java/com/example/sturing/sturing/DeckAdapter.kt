...
class DeckAdapter(var items: ArrayList<Deck>, var context: Context, var group: String) : RecyclerView.Adapter<DeckAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        ...
        ViewCompat.setTransitionName(p0.ivDeck, items[p1].key)
        ...
        p0.deckItem.setOnClickListener {
            var i = Intent(p0.deckItem.context, DetailDeckActivity::class.java)
            ...
            val options = ActivityOptionsCompat.makeSceneTransitionAnimation(p0.deckItem.context as Activity, p0.ivDeck, ViewCompat.getTransitionName(p0.ivDeck)!!)
